...
public class CustomAdapter extends ArrayAdapter<CustomItem>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.itemDate = convertView.findViewById(R.id.date);
            viewHolder.quantity = convertView.findViewById(R.id.quan);
        ...
        viewHolder.itemNum.setText(dataModel.getItemNumber());
        viewHolder.itemDate.setText(dataModel.getDatey());
        viewHolder.quantity.setText(dataModel.getQuan());
